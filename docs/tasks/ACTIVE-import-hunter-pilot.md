...
**Pausas por tareas de frontend urgentes (2026-08-15/16, cuatro veces):**
ver `docs/tasks/done/DONE-mejoras-navbar-hero-categorias.md`,
`docs/tasks/done/DONE-landing-categorias.md`,
`docs/tasks/done/DONE-drag-carousel-dropdown-catalogo.md` y
`docs/tasks/done/DONE-cierre-brechas-ux-hunter.md`, las cuatro ya
